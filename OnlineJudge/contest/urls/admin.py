...
from ..views.admin import ContestAnnouncementAPI, ContestAPI, ACMContestHelper, DownloadContestSubmissions, ContestAssignStudents
...
urlpatterns = [
    ...
    url(r"^contest_assign/?$", ContestAssignStudents.as_view(), name="assign_students_api"),
]
