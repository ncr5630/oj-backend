...
class EditUserSerializer(serializers.Serializer):
    ...
    username = serializers.CharField(max_length=32)
    real_name = serializers.CharField(max_length=100, allow_blank=True, allow_null=True)
...
class EditUserProfileSerializer(serializers.Serializer):
    real_name = serializers.CharField(max_length=100, allow_null=True, required=False)
